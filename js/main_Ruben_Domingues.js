...
(function() {
    ...
    function animeLine(line){
        var line =$('.dad-cell input[data-line='+line.attr("data-line")+']');
    ...
    console.log(countNrLine);
        var column =$('.dad-cell input[data-column='+target.attr("data-column")+']');
        var countNrColumn=0;
